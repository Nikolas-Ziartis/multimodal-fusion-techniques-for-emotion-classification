...
# make a readable string from a dict of metrics
...
# pick a gpu with enough free memory
...
# distillation loss between two sets of logits
...
# penalty that keeps the router from always picking one modality
